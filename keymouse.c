...
int keymouse()
{
	...
	fprintf(stderr, "DJB: mevent.x is %d\n", mevent.x);
	fprintf(stderr, "DJB: mevent.y is %d\n", mevent.y);
	fprintf(stderr, "DJB: mevent.bstate is %d\n", mevent.bstate);
	//fprintf(stderr, "DJB: BUTTON1_PRESSED is %d\n", BUTTON1_PRESSED);
	//fprintf(stderr, "DJB: mevent.bstate & BUTTON1_PRESSED is %d\n", mevent.bstate & BUTTON1_PRESSED);
