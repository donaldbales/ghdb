...
int formscrn(struct FIELD fields[], int num_fields)
{
	...
	fields[PLANT_NAME_FIELD].value.x = 22;
	...
	fields[LATIN_NAME_FIELD].value.x = 22;
	...
	fields[HEIGHT_FIELD].value.x = 22;
	...
	fields[PLANTING_DEPTH_FIELD].value.x = 22;
	...
	fields[PLANTING_DEPTH_FIELD].uom.x = 28;
	...
	fields[SEED_SIZE_FIELD].label.x = 36;
	...
	fields[SEED_SIZE_FIELD].value.x = 47;
	...
	fields[SEED_SIZE_FIELD].uom.x = 53;
	...
	fields[SEED_NEED_LIGHT_FIELD].value.x = 22;
	...
	fields[SEED_NEED_LIGHT_FIELD].uom.x = 28;
	...
	fields[SEED_SCARIFICATION_FIELD].label.x = 36;
	...
	fields[SEED_SCARIFICATION_FIELD].value.x = 47;
	...
	fields[SEED_SCARIFICATION_FIELD].uom.x = 53;
	...
	fields[DAY_LIGHT_INTERVAL_FIELD].value.x = 22;
	...
	fields[DAY_LIGHT_INTERVAL_FIELD].uom.x = 28;
	...
	fields[PHOTOPERIOD_HOURS_FIELD].value.x = 22;
	...
	fields[PHOTOPERIOD_HOURS_FIELD].uom.x = 28;
	...
	fields[FROST_TOLERANCE_FIELD].label.x = 1;
	...
	fields[FROST_TOLERANCE_FIELD].value.x = 22;
	...
	fields[FROST_TOLERANCE_FIELD].uom.x = 28;
	...
	fields[POLLINATION_PRIMARY_FIELD].value.x = 22;
	...
	fields[POLLINATION_PRIMARY_FIELD].uom.x = 53;
	...
	fields[POLLINATION_SECONDARY_FIELD].value.x = 22;
	...
	fields[POLLINATION_SECONDARY_FIELD].uom.x = 53;
